...
char ext_info[];
{
  /* Benutzer kann Pfad und File bergeben, dabei werden dann
     die Adresse des kompletten Zugriffspfades zurckgegeben,
     Sollte der Benutzer Abbruch anklicken, wird NULL zurckgegeben */
  ...
  i=0;
  do {
    path_file[backslash+i]=file[i];         /* Filenamen anh„ngen */
    } while(file[i++]!=0);
