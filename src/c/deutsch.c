...
#define romstr008 "DU HAST SEIT LANGER ZEIT SCHULDEN. BEVOR DU DIE NICHT ZURšCKGEZAHLT HAST, BEKOMMST DU KEINE WEITEREN WAREN."
#define romstr009 " "											/* ! */
#define romstr010 " "											/* ! */
#define romstr011 ", "										/* ! */
#define romstr012 ". "										/* ! */
...
#define romstr059 "DIESER SPIELSTAND IST MIT EINER ŽLTEREN VERSION VON ROM 2 GESPEICHERT -> NICHT LADBAR."
#define romstr060 "FEHLER BEIM ABSPEICHERN! (DISK SCHREIBGESCHšTZT ODER DEFEKT?)"
...
#define romstr065 " "											/* ! */
#define romstr066 "ACHTUNG! NŽCHSTEN MONAT MUSST DU #0 ZAHLEN. DU HAST NUR: #1"		/* [costs][money] */
#define romstr067 "INFO"
#define romstr068 "INFO"
#define romstr069 "BEV™LKERUNG  :"
...
#define romstr077 "DEIN ANGEBOT FšR"
...
#define romstr086 "WENN DU DEN PREIS JETZT ŽNDERST, WIRD DER REST DER INTERESSIERTEN LEUTE GEHEN. PREIS ŽNDERN?"
#define romstr087 "WENN DU DIE RASSE JETZT ŽNDERST, WIRD DER REST DER INTERESSIERTEN LEUTE GEHEN. RASSE ŽNDERN?"
#define romstr088 "DU KANNST NICHT MEHR SCHIFFE BEKOMMEN, WEIL DU H™CHSTENS #0 SCHIFFE HABEN KANNST."
...
#define romstr115 "MŽNNER šBRIG   :"
#define romstr116 "GEWŽHLTE MŽNNER: \\]^_      `abc"
...
#define romstr168 "WAFFENHŽNDLER"
#define romstr169 "WAFFENHŽNDLER"
#define romstr170 "   ZAHL AN SOLDATEN MIT:~"
#define romstr171 "  ZAHL AN SOLDATEN OHNE:~"
#define romstr172 " PREIS FšR EINEN SOLDAT:"
#define romstr173 "EINHEIT:~"
#define romstr174 "  SUMME:"
#define romstr175 " WŽHLE: ^_           `a~"
...
#define romstr194 "DU KANNST DIE STADT NICHT VERLASSEN, WEIL DEINE GLEITER NICHT SO VIEL TRAGEN K™NNEN."
#define romstr195 "STADT VERLASSEN"
#define romstr196 "#0 VERLASSEN?"										/* [city] */
#define romstr197 "KASERNE"
#define romstr198 "KASERNE"
#define romstr199 "DIE WACHE LŽSST DICH NICHT VORBEI!"
#define romstr200 "DEINE ARMEE:"
#define romstr201 "ZEITVERZ™GERUNG:"
#define romstr202 ":"
#define romstr203 "<-      ->"
#define romstr204 "----------"
#define romstr205 "--------"
...
#define romstr214 " GEWŽHLTES GELD : \\]^_        `abc"
...
#define romstr224 "DIE ROYAL FALCON BANK MACHT KEINE GESCHŽFTE MIT BANKRŽUBERN WIE DU ES BIST."
#define romstr225 "AKTIENMARKT"
#define romstr226 "CHART-ANALYSE KOSTET 10000. TROTZDEM AUSFšHREN?"
#define romstr227 "LAGER"
#define romstr228 "PREIS"
#define romstr229 "  ANZAHL"
#define romstr230 "DEINE WARE:    ANZAHL"
#define romstr231 "GEWŽHLTE WARE:"
...
#define romstr237 "MAKLER-GEBšHR: 2%"
#define romstr238 "%f"
...
#define romstr258 "DU BRAUCHST 30000 FšR EINE MINE, HAST ABER NICHT SO VIEL GELD."
#define romstr259 "...SIR !!!! WIR HABEN EINEN SCHATZ GEFUNDEN! WERT: #0"		/* [value] */
#define romstr260 "DU HAST #0 KARREN MIT DRECK GEFšLLT. DU HAST SIE VERLOREN."	/* [number] */
#define romstr261 "DRECK"
#define romstr262 "DU HAST KEIN F™RDERSYSTEM."
#define romstr263 "DU HAST SCHON 3 F™RDERSYSTEME."
#define romstr264 "DU HAST KEIN PUMPENSYSTEM!"
#define romstr265 "DU HAST SCHON 3 FILTERSTUFEN."
#define romstr266 "DU HAST KEINEN ™LTANK!"
#define romstr267 "DU HAST SCHON 3 ™LTANKS."
#define romstr268 "BIST DU SICHER, DASS DU DIESE MINE SCHLIESSEN WILLST?"
#define romstr269 "MINE"
#define romstr270 "SOVIEL WIE M™GLICH AUF DIE~GLEITER LADEN.~~"
#define romstr271 "NEUES F™RDERSYSTEM ERRICHTEN~(KOSTEN: 5000)~~"
#define romstr272 "NEUES PUMPENSYSTEM EINBAUEN~(KOSTEN: 1000)~~"
#define romstr273 "NEUEN ™LTANK EINBAUEN~(KOSTEN: 4000)~~"
#define romstr274 "MINE SCHLIESSEN~(KOSTEN: 5000)"
#define romstr275 "LAGERHAUS:~~"
#define romstr276 "DIESE MINE WURDE GE™FFNET~~"
...
#define romstr285 "S: KAMPFSTŽRKE ANZEIGEN"
#define romstr286 "O: GEGNER ZEIGEN"
#define romstr287 "T: SCHŽTZE ANZEIGEN"
...
#define romstr294 "X: ALLE TšRE OFFEN"
...
#define romstr299 "L: LICHT VOLLE STŽRKE"
#define romstr300 "U: UNSTERBLICH IM BUNKER"
#define romstr301 "WELCHEN BUNKER M™CHTEN"
...
#define romstr311 "ACHTUNG! DU HAST NUR NOCH FšR EINEN MONAT GELD!"
#define romstr312 "NOTIZBLOCK"
#define romstr313 "NOTIZBLOCK"
#define romstr314 "0%"
#define romstr315 "100%"
#define romstr316 "šBERLADEN"
...
#define romstr356 "AUFKLŽRER   "
#define romstr357 "HELIKOPTER  "
#define romstr358 "SANITŽTER   "
...
#define romstr406 "ZERST™RER"
#define romstr407 "KREUZER"
#define romstr408 "MILCH"
#define romstr409 "KŽSE"
#define romstr410 "SALAT"
#define romstr411 "ŽPFEL"
...
#define romstr421 "F™RDERTURM"
#define romstr422 "PUMPE"
#define romstr423 "™LTANK"
...
#define romstr462 "TROCKENE WšSTE"
#define romstr463 "WšSTE"
#define romstr464 "HALBWšSTE"
#define romstr465 "BRšCKE"
#define romstr466 "LICHTER WALD"
#define romstr467 "WALD"
#define romstr468 "HšGEL"
...
#define romstr485 "KŽMPFER"
#define romstr486 "MAGIER"
#define romstr487 "MOGUL"
#define romstr488 "ZAUBERMEISTER"
#define romstr489 "DIES IST DIE LETZTE TšR, WELCHE DICH NOCH VON MEDUSA TRENNT. M™CHTEST DU SIE WIRKLICH ™FFNEN?"
...
#define romstr505 "DIES IST EIN SCHLšSSEL ZU MEDUSA'S GEHEIMBUNKER."
#define romstr506 "DIES IST EIN SCHLšSSEL."
#define romstr507 "DIES IST EINE WAFFE."
#define romstr508 "DIES IST MUNITION. ES SIND #0 SCHšSSE šBRIG."
...
#define romstr513 "ES GIBT WŽNDE, DIE WIE WŽNDE AUSSEHEN, ABER..."
...
#define romstr529 "KEINE RICHTUNG FšR DEN FEIND!"
#define romstr530 "DU HAST SCHON VIER LEUTE."
#define romstr531 "WILLST DU GEFANGENEN '#0' BEFREIEN?"				/* [name] */
#define romstr532 "DIE SCHUSSSTŽRKE IST DIE SUMME DER EINGESCHALTETEN EINZELSCHšSSE."
...
#define romstr540 "KŽMPFE FšR DEIN REICH!"
...
#define romstr555 "WILLST DU DEINE AUFKLŽRER AUSSENDEN, UM ZU SCHAUEN, WIEVIEL SOLDATEN DER GEGNER HAT? KOSTEN: 2000."
#define romstr556 "ICH BIN DER MŽCHTIGE PRINZ! GEH HEIM~"
#define romstr557 "ZU DEINER FRAU UND HILF IHR KOCNEN!~~"
#define romstr558 "ICH ZAHLE       FšR DEN FRIEDEN."
#define romstr559 "OKAY, ICH NEHME DAS GELD, STATT ZU KŽMPFEN...."
#define romstr560 "SO WENIG GELD? DU VERLIERST SOWIESO DEN KAMPF UND ICH BEKOMME DEIN GANZES GELD."
#define romstr561 "ENTSCHULDIGUNG, DASS WIR SOVIEL SCHWIERIGKEITEN GEMACHT HABEN. UUUUUND TSCHšSS!!"
#define romstr562 "HAR, HAR, HAR.... DU, DER MŽCHTIGE PRINZ? SO'N QUATSCH!"
...
#define romstr581 "KŽMPFE GEGEN #0"						/* [name] */
...
#define romstr589 "DU, SOHN DES B™SEN K™NIGS HAST KEINEN ZUTRITT ZU MEDUSAS'STADT."
...
#define romstr592 "HALLO SIR! WILLST DU NICHT IN UNSERE SCH™NE STADT #0 KOMMEN?"	/* [city] */
...
#define romstr598 "DIE REEDEREI VON #0 HAT EINEN #1 FšR DEINE FLOTTE GEBAUT."	/* [city][ship] */
