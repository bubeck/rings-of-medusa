...
#define Y0 17		/* Gr”že der oberen Leiste */
...
#define O_KUGEL			99	/* Kanonenkugel (grož -> klein) */
...
#define SCHUSSDELAY		40	/* Anzahl Frames zwischen den Schssen */
#define TREFFERRADIUS	30	/* Treffer innerhalb von 15 m */
#define O_TURMDREH		27	/* Feindlicher Geschtzturm dreht sich */
...
typedef struct
{
	...
	int		Turmwinkel;		/* Winkel des Geschtzturms */
