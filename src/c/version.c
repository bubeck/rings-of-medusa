...
/* In dieser Datei wird eingestellt, was fr eine Version von
...
/* Versionen:
    ...
    0.01: erste Version, Beginn der Aktienkurse (9.3.1990)
		...
		0.04: Expressversion fr European Computer Trade Show at London
					Erste Objekte in den Bunkern, Roulette fertig (11.4.1991)
		0.05:	neue GMAPs, neue TMAPS, s„mtliche Konstanten angepažt, 
					neue Stadtgrafiken, Schilder, Aufzge in den Bunkern
					-> erste Volltestversion (10.5.1991)
		0.06: Intro, Automapper, Tren bleiben offen (28.5.1991)
		0.07: Items k”nnen bewegt werden, betretbare W„nde, Windows in den St„dten,
		...
		0.11: animierte Gegner, neue Reagenzgl„ser und Objekte,
					Notizblockbug entfernt (29.6.1991)
					-> ASM, Powerplay, Starbyte, Zimmermann
		0.12: Gefangene, Reagenzgl„ser mit Funktion, Totenkopf.
		...
		0.15: Laden und Abspeichern 2. Teil, Schuž des Spielers, Schuž macht heller,
		...
		1.01: Roboter schiežen nun auch von hinten, Schwierigkeitsgrad des Schiffskampfes
					erh”ht. -> ASM (7.8.1991)
		1.02: Lade/Tastaturbug behoben. Neue Passw”rter.
					-> Master Atari, Test Amiga (12.8.1991)
		1.03: Roboter nicht auf Aufzugstren.
		      -> Master Atari (13.8.1991)
		1.04: Amigaversion, Atari Master -> Starbyte, Zimmermann (15.8.1991)
		1.05: Objekte k”nnen geworfen werden, kleinere Bugs beseitigt, neue Passw”rter
		...
		1.07: Handshake fr Tastatur auf 75 æs angepažt (Amiga 2000-A)
		...
		1.11: neuer LOADER.SRC mit RAM-Test ohne $ff8001-Zugriff (ST)
					Schlsselwerfbug, Datendiskettenformat umgestellt
		...
		1.13: englische Version mit englischen Passw”rtern
		      Amiga, Atari Master -> Starbyte (3.1.1992)
		1.14: korrigierte englische Passw”rter, wegen Handbuchumbruch
