...
#define TIMEOUT 25000                 /* Timeout fÅr Kopierschutz */

#define LADEN 0            /* verschiedene ZustÑnde fÅr ort in buy_sell() */
#define JUWELLIER 1
#define AKTIEN 2

#define MUSIK_AN 1
#define MUSIK_AUS 2                /* 2 ZustÑnde fÅr Hippelspielmusik */
...
#define MAX_PRICE 995           /* maximal 995 fÅr ein Crewmitglied */
#define BERUFE 10
...
#define CHG_MAX 400          /* Max. 400 UntergrundsÑnderungen */
#define KAP_KARREN 80       /* Karren nimmt 80 Waren auf */

#define FILES 45            /* 18 Bilderfiles */
#define TIEFE 5             /* fÅr Armeesteuer, max. 5 Verschachtelungen */

#define MAUS_AN 10          /* TRAP #10 zeichnet Maus auf Bildschirm */
#define MAUS_AUS 11         /* Trap #11 lîscht sie wieder weg */

#define AN_BORD 1           /* fÅr "standort", fÅr die Armee */
#define AN_LAND 2           /* -"- */
#define NIRGENDS 3          /* Armee nicht vorhanden */

#define ANGRIFF 1
#define RUECKZUG 2          /* Befehle fÅr die Einheiten beim Kampf */
...
#define WANDMAX 40					/* max. Anzahl an WandeintrÑger in BUNKERWAND[] */
#define TUERMAX 140					/* Gesamtzahl der TÅren in allen Bunkern */
#define ITEMMAX (TUERMAX+570)	/* Gesamtzahl an Objekten in allen Bunkern (SchlÅssel+Items) */
...
#define LEER 0 
#define DOOR_ZU_START 32768		/* geschlossene TÅren haben Feldnummer von hier ... */
#define DOOR_ZU_END 35999			/* ... bis hier. */
#define DOOR_AUF_START 36000		/* offene TÅren von hier ... */
#define DOOR_AUF_END 38000		/* ....bis hier. */
#define ITEM_START 1					/* In der Datei steht, welches Objekt an welcher Stelle */
#define NOKEY_START 10000			/* Ab hier kommen keine SchlÅssel mehr */
