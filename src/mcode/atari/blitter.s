...
;Es stellt die Auswertung der Eingabewerte für Line_A #7 BitBlt dar.
...
Begin:          adda.w  #76,A6               ;Ans Ende des Parameterblocks gehen
                ...
                move.w  D0,D4
                move.w  D2,D6
                move.w  -74(A6),D1           ;Höhe in Pixeln
                subq.w  #1,D1
...
blitter:        lea     $00FF8A3C,A5         ;Blitter Opcoderegister
                ...
                muls    -54(A6),D1           ;Offset zum nächsten Word dergleichen Plane (Source)
...
L0002:          muls    -40(A6),D1           ;Offset zum nächsten Wort dergleichen Plane (Dest)
...
L0003:          move.w  D0,D1                ;Source X1
                muls    -54(A6),D1           ;Offset zum nächsten Wort dergleichen Plane
                move.w  -60(A6),D5           ;Source Y1
                muls    -52(A6),D5           ;Breite Quelle in Bytes
                add.l   D1,D5                ;=Offset
...
L0006:          move.w  -54(A6),D2           ;Offset zum nächsten Wort dergleichen Plane (Source)
                move.w  -40(A6),D3           ;Offset zum nächsten Wort dergleichen Plane (Dest)
...
L0008:          and.w   #$000F,D7            ;Skew
                ...
                move.w  D3,-14(A5)
                move.w  D2,-28(A5)           ;Offset zum nächsten Wort dergleichen Plane (Source)
                bne.s   L000A
...
L000A:          movea.w -50(A6),A2           ;Offset zur nächsten Plane (Source)
                movea.w -36(A6),A3           ;Offset zur nächsten Plane (Dest)
                move.w  -68(A6),D2           ;Hintergrundfarbe
                move.w  -70(A6),D3           ;Vordergrundfarbe
                move.w  -74(A6),D4           ;Höhe in Pixeln
...
L000B:          move.l  A0,-24(A5)           ;Source-Adresse
                ...
                addx.w  D6,D6
                move.b  -66(A6,D6.w),-1(A5)  ;log.Verknüpfung
                move.w  D7,(A5)              ;Transfer starten
                adda.w  A2,A0
                adda.w  A3,A1                ;und auf nächste Plane gehen
