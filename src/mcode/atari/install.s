...
kein_format2:   bsr     wipe_disk
                ...
                move.b  laufwerk+1(PC),bootsektor+9 ;Bootsektor nicht ausführbar
...
read_file:      lea     reading(PC),A0
                ...
                move.l  D7,D0                ;Länge zurückgeben
                rts
...
;   A6.L: Ladeadresse
;   D0.L: Filelänge
write_file:     move.l  D0,D7                ;Filelänge merken
...
titel:          DC.B 27,"E"
                DC.B 'Installierprogramm für Rings of Medusa II - Atari ST',13,10
                DC.B '╜ 1991 by Till Bubeck, Ziegeleistr. 28, 7056 Weinstadt',13,10,10
                DC.B "Zum Formatieren der Disketten bitte '+' drücken: ",0
...
bootprogramm:   DS.B 512
                ...
                BSS
file_len:       DS.L 1          ;Länge des aktuellen Archivs
laufwerk:       DS.W 1
format:         DS.W 1
