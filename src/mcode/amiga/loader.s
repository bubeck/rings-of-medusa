...
programmstart:  lea     $00080000,SP
                ...
                move.w  #7999,D7
clear_screen:   clr.l   (A0)+           ;Bildschirm löschen
...
color_loop:     move.w  (A0)+,D0
                ...
                bsr     get_len         ;Länge der MEDUSA_A.PRG holen
                bra     load_medusa
...
;Lädt Medusa.prg über's Amigatool
load_tool:      link    A6,#0
                movem.l D1-A5,-(SP)
...
;Bestimmt die Länge von O:\MEDUSA_A.PRG über's Amigatool
get_len:        movem.l D0-A6,-(SP)
                ...
                move.l  dta_len,D0
                move.l  D0,medusa_len   ;Länge merken
                move.l  D0,$00060000
